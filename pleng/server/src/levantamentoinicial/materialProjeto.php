    ...
    while ($row = $result->fetchArray()) {
        echo "<div class='grid-12 etapa'>";
            ...
            echo "<table>";
                ...
                $resultMat = $db->query("SELECT material.nome as nome, SUM(qtde_material.qtde) as qtde
                                    FROM etapa_projeto
                                    ...
                                    WHERE etapa_projeto.idproj = $id AND material_etapa.idmat = qtde_material.idmat
