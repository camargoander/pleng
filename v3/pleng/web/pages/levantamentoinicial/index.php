...
<body>
    ...
    <?php include('../../assets/cmp/menulateral/index.php'); ?>
        ...
        <main>
                        ...
                        <div class="items">
                            ...
                            <div class="item">
                                <div class="field">
                                    ...
                                    <div class="container">
                                        <div class="contRadio">
                                            <input type="radio" class="hidden" id="input1" name="situacao" value="naoIni">
                                            <label class="entry" for="input1"><div class="circle"></div>
                                                <div class="entry-label">Não iniciada</div>
                                            </label>
                                            <input type="radio" class="hidden" id="input2" name="situacao" value="andam">
                                            <label class="entry" for="input2">
                                                <div class="circle"></div>
                                                <div class="entry-label">Em andamento</div>
                                            </label>
                                            <input type="radio" class="hidden" id="input3" name="situacao" value="final">
            ...
            <?php include('../../../etapasCadastradas.php'); ?>
